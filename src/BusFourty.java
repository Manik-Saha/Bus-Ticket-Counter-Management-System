...
public class BusFourty extends JFrame implements ActionListener {
	
	JButton a1,a2,a3,a4,b1,b2,b3,b4,c1,c2,c3,c4,d1,d2,d3,d4,e1,e2,e3,e4,f1,f2,f3,f4,g1,g2,g3,g4,h1,h2,h3,h4,i1,i2,i3,i4,j1,j2,j3,j4,confirm;
...
public BusFourty() {
    ...
    panel1.setBounds(20,20,250,700);
    add(panel1);
    ...
    a4 = new JButton("A4");
    panel1.add(a4);
    this.a4.addActionListener(new ActionListener() {
   ...
   // c2.setBounds(x, y, width, height);
    ...
    //a3.setBounds(x, y, width, height);
    panel1.add(c4);
    this.c4.addActionListener(new ActionListener() {
   ...
   // d2.setBounds(x, y, width, height);
    ...
    //a3.setBounds(x, y, width, height);
    panel1.add(d4);
    this.d4.addActionListener(new ActionListener() {
   ...
   // e3.setBounds(x, y, width, height);
    ...
    //a3.setBounds(x, y, width, height);
    panel1.add(e4);
    this.e4.addActionListener(new ActionListener() {
   ...
   // g3.setBounds(x, y, width, height);
    ...
    //a3.setBounds(x, y, width, height);
    panel1.add(g4);
    this.g4.addActionListener(new ActionListener() {
   ...
   // h3.setBounds(x, y, width, height);
    ...
    //a3.setBounds(x, y, width, height);
    panel1.add(i4);
    this.i4.addActionListener(new ActionListener() {
